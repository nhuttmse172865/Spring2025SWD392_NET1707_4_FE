...
const Item = ({
  ...
  return (
    <ul
      className="text-[15px] relative font-normal text-[rgba(0,0,0,0.5)] hover:bg-[rgba(0,0,0,0.05)]  ease-in duration-200 cursor-pointer  grid justify-around items-center rounded-[0.375rem] gap-[15px] min-h-[100px]"
      style={{
        gridTemplateColumns: "0.5fr 1fr 2.5fr 3fr 4.5fr 0.5fr",
        padding: "0 15px",
