...
const Navigation = () => {
  ...
  return (
    <ul className=" min-w-[200px] max-w-[250px] h-fit pt-5 pb-10 px-2.5 rounded-[.375rem]">
      {listNavigation.map((item, index) => (
        <li
          onClick={() => navigate(item.path)}
          className="flex gap-4 w-full h-[50px] items-center px-2.5 py-5 hover:bg-white rounded-[.375rem] cursor-pointer"
        >
