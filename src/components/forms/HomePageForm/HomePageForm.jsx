...
//       description: 'Tất cả bác sĩ O2 SKIN đều tốt nghiệp Đại học Y khoa và có chứng chỉ hành nghề do bộ Y tế cấp, nên tầng chuyên môn vững chắc, am hiểu sâu hiện thực.'
//     },
//     {
//       id: 2,
//       icon: '⚕️',
//       title: 'Nhiều Năm Kinh Nghiệm',
//       description: 'Các Bác sĩ O2 SKIN có kinh nghiệm nhiều năm trong việc chẩn đoán và lựa chọn cách hữu hiệu.'
//     },
//     {
//       id: 3,
//       icon: '👍',
//       title: 'Tư Vấn Trung Thực, Tận Tâm',
//       description: 'Bác sĩ O2 SKIN luôn lắng nghe và tận tâm với khách hàng, cam kết tư vấn trung thực.'
//     },
//     {
//       id: 4,
//       icon: '📈',
//       title: 'Luôn Cập Nhật Và Nâng Cao Kiến Thức Điều Trị',
//       description: 'Bác sĩ O2 SKIN luôn cập nhật các phương pháp điều trị tiên tiến.'
//     }
//   ];
...
//       mainImage: '/AssetsHomePage/SkinCare.png',
//       thumbnail: '/AssetsHomePage/SkinCare.png',
//     },
//     {
//       id: 3,
...
//         <section ref={aboutUsRef} className="section" id="aboutUs">
...
//           </div>
//         </section>
//         <section ref={therapistRef} className="section" id="therapist">
//           <div className="doctor-team">
//             <h1 className="doctor-team__title">Tiêu Chuẩn Trở Thành Bác Sĩ O2 SKIN</h1>
...
//               ))}
//             </div>
//             <h2 className="doctor-team__subtitle">Đội Ngũ Bác Sĩ O2 SKIN</h2>
  ...
  return (
    <div className="home-page-container">
      ...
      <div className="home-page-body">
        ...
        >
          <h1 className="gallery-tittle">Giới thiệu về phòng khám của chúng tôi</h1>
          <div className="gallery-container">
            <div className="gallery-main">
              <AnimatePresence mode="wait">
                <motion.div
        ...
        >
          <div className="doctor-team">
            <h1 className="doctor-team__title">Tiêu Chuẩn Trở Thành Bác Sĩ</h1>
            <div className="standards">
              {standards.map((standard) => (
                <div key={standard.id} className="standard-card">
                  <span className="standard-card__icon">{standard.icon}</span>
